...
setCombatFormula(combat1, CALLBACK_PARAM_LEVELMAGICVALUE, -15.0, -1700, -15.0, -2000)
...
function onCastSpell(cid, var)
    ...
    addEvent(doSendMagicEffect, 1, {x = pos_target.x, y = pos_target.y, z = pos_target.z}, 317)
