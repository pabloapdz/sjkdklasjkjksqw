...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -1.75, -450, -1.75, -650)
...
doSendMagicEffect(targetpos, 1001)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -1.75, -450, -1.75, -650)
