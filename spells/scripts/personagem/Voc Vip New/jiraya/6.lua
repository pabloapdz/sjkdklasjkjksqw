...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -10.0, -1050, -13.0, -1250)
...
doSendMagicEffect(targetpos, 1000)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -10.0, -1050, -13.0, -1250)
