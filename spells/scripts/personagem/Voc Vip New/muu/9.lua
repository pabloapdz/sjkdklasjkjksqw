...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -10.0, -1000, -11.0, -1150)
...
doSendMagicEffect(targetpos, 1045)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -10.0, -1000, -11.0, -1150)
...
doSendMagicEffect(targetpos, 1044)
...
--doCreatureSay(cid, "Doton Dai Noboru", TALKTYPE_MONSTER)
