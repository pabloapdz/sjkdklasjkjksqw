...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -10.0, -3500, -12.0, -4000)
...
doSendMagicEffect(targetpos, 1108)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -10.0, -3500, -12.0, -4000)
...
doSendMagicEffect(targetpos, 1109)
...
--doCreatureSay(cid, "Dai Hirudora", TALKTYPE_MONSTER)
