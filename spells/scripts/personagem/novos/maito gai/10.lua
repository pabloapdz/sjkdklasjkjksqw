...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, -25, -9000, -30.0, -16000)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_HITCOLOR, 66)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -8.4, -3000, -10.0, -5334)

local combat3 = createCombatObject()
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_HITCOLOR, 66)
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -8.4, -3000, -10.0, -5334)
