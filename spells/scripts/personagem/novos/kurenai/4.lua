...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -3.5, -3500, -4.5, -4500)
...
doSendMagicEffect(targetpos, 938)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -3.5, -3500, -4.5, -4500)
