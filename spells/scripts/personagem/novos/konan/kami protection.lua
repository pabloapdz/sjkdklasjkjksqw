...
doSendMagicEffect(position1, 858) -- Pause
end

local function effect02(position2)
doSendMagicEffect(position2, 859) -- Effect
end

local function effect03(position3)
doSendMagicEffect(position3, 859) -- Broken
end
...
if isInRange(getCreaturePosition(cid), from1, to1, from2, to2, from3, to3, from4, to4, from5, to5, from6, to6, from7, to7, from8, to8, from9, to9, from10, to10, from11, to11, from12, to12, from13, to13, from14, to14, from15, to15) then   doPlayerSendTextMessage(cid, 27, "voce nao pode usar Suna no Yoroi aqui!")
   return doSendMagicEffect(getCreaturePosition(cid), 2)
end

      local position1 = {x=getThingPosition(cid).x+2, y=getThingPosition(cid).y+2, z=getThingPosition(cid).z, config.duration * 1000, false}
      local position2 = {x=getThingPosition(cid).x+1, y=getThingPosition(cid).y+1, z=getThingPosition(cid).z, config.duration * 1000, false}
      local position3 = {x=getThingPosition(cid).x+1, y=getThingPosition(cid).y+1, z=getThingPosition(cid).z, config.duration * 1000, false}
...
doCreatureSay(cid,"Kami Protection", 19)
addEvent(effect02, 100, position2)
addEvent(effect01, 600, position1)
addEvent(effect01, 800, position1)
addEvent(effect01, 1100, position1)
addEvent(effect01, 1500, position1)
addEvent(effect01, 1800, position1)
addEvent(effect01, 2100, position1)
addEvent(effect01, 2500, position1)
addEvent(effect01, 2800, position1)
addEvent(effect01, 3100, position1)
addEvent(effect01, 3500, position1)
addEvent(effect01, 3800, position1)
addEvent(effect01, 4100, position1)
addEvent(effect01, 4500, position1)
addEvent(effect01, 4800, position1)
addEvent(effect01, 5100, position1)
addEvent(effect01, 5500, position1)
addEvent(effect01, 5800, position1)
addEvent(effect01, 6100, position1)
addEvent(effect01, 6500, position1)
addEvent(effect01, 6800, position1)
addEvent(effect01, 7100, position1)
addEvent(effect01, 7500, position1)
addEvent(effect01, 7800, position1)
addEvent(effect01, 8100, position1)
addEvent(effect01, 8500, position1)
addEvent(effect01, 9200, position1)
addEvent(effect01, 9500, position1)
