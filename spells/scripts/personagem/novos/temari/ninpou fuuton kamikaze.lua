...
doSendMagicEffect(targetpos, 860)
...
doSendMagicEffect(targetpos, 861)
...
addEvent(onCastSpell2, 1100, parameters, target)

-- doCreatureSay(cid, "Ninpou Fuuton Kamikaze", TALKTYPE_MONSTER)
