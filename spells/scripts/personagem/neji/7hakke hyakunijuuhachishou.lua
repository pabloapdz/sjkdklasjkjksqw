...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -13, -2625, -17, -3750)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -0.0, 9.5, -0.0, 9.5)
...
doSendMagicEffect(position1, 527)
return TRUE
end 