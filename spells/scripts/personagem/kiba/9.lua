...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -10.0, -6075, -15.0, -8000)
...
doSendMagicEffect(targetpos, 852)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -10.0, -6075, -15.0, -8000)
...
doSendMagicEffect(targetpos, 400)
...
-- doCreatureSay(cid, "Chou Garouga", TALKTYPE_MONSTER) 
