...
setCombatFormula(combat1, CALLBACK_PARAM_LEVELMAGICVALUE, -13.5, -4000, -16, -5500)
...
function onCastSpell(cid, var)
    ...
    addEvent(doSendMagicEffect, 1, {x = pos_caster.x+2, y = pos_caster.y, z = pos_caster.z}, 752)
    addEvent(onCastSpell1, 600, cid, var)
