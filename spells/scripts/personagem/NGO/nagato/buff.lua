...
local effect = {877} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
     
local ml = 120 -- quantos ira aumentar o skill de ML
...
local function magicEffectNAGATO(tempo2,tempo3,cid)
...
if getPlayerStorageValue(cid, storage2) ~= 1 or getCreatureCondition(cid, CONDITION_REGENERATION, 1) == false then
    ...
    while (tempo2 ~= (tempo*1000)) do
        addEvent(magicEffectNAGATO, tempo2, tempo2, tempo*1000, cid)
        tempo2 = tempo2 + 300
    end
