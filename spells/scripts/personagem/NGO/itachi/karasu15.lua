...
setCombatParam(combat1, COMBAT_PARAM_DISTANCEEFFECT, 122)
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -9.5, -1425, -9.5, -2850)
...
doSendMagicEffect(position1, 302)
