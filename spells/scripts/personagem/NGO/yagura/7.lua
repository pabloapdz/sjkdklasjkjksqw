...
local pos2 = {x=pos_target.x-1, y=pos_target.y, z=pos_target.z}
local pos3 = {x=pos_target.x+2, y=pos_target.y, z=pos_target.z}
...
addEvent(doSendMagicEffect, 100, pos2, 1214)
--addEvent(doSendMagicEffect, 300, pos3, 1204)
