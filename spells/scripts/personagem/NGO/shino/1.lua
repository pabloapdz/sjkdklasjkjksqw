...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -0.7, -67, -1.0, -100)
...
local function onCastSpell1(cid, var)
	...
	local pos = {x=getThingPosition(getCreatureTarget(cid)).x, y=getThingPosition(getCreatureTarget(cid)).y, z=getThingPosition(getCreatureTarget(cid)).z}
	addEvent(doSendMagicEffect, 1, {x = pos.x, y = pos.y, z = pos.z}, 68)
