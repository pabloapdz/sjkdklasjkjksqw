...
addDamageCondition(condition, 20, 1500, -15000)
...
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -15.0, -1600, -15.0, -1900)
...
doSendMagicEffect(targetpos, 959)
...
addEvent(doSendMagicEffect, 0, position, 958)
