...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -14.0, -1500, -15.0, -1750)
...
doSendMagicEffect(targetpos, 994)
doCombat(parameters.cid, parameters.combat1, parameters.var)
end

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -14.0, -1500, -15.0, -1750)
...
doSendMagicEffect(targetpos, 996)
